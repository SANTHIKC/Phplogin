        ...
        <div class="row">
            ...
            <div class="col-4">
                ...
                <h1>Registration Form</h1>
                    ...
                    <input type="text" name="name" class="form-control mt-2" value="<?php echo $data['name'];?>" >
                    <input type="text" name="mobile" class="form-control mt-2" value="<?php echo $data['mobile'];?> ">
                    <input type="email" name="email" class="form-control mt-2" value="<?php echo $data['email'];?>">
                    <br>
